...
function Keyboard({submitenter,dataitem,keyval,keyremove}) {
  const keyboardClick = (e) => {
    dataitem(e.target.getAttribute("data-key"));
    }
  

  return (
    <> <div className="typeKeyboard px-5"> 
    <input type="text"  className='typeval'   value={keyval} readOnly placeholder='Ice Skating' />
   </div>
