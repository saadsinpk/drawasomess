...
function AdminSetting() {
  ...
  const putData = async () => {
    ...
    axios
      .get(`${config.apiEndPoint}adminInfo`)
      .then((response) => {
        let a = response.data.userId;
        getData(a);
      })
      .catch((error) => {
        setLoading(true);
  ...
  const getData = async (a) => {
    ...
    axios
      .get(`${config.apiEndPoint}profile/${a}`)
      .then((response) => {
        setUserdata({
  ...
  const onSubmit = async (values) => {
    ...
    axios
      .put(`${config.apiEndPoint}update/1`, values)
      .then((response) => {
              ...
              return (
                <Form>
                  <div className="inputBox">
                    <Field type="text" name="primary_email" />
                  ...
                  <div className="inputBox">
                    <Field type="text" name="instagram_link" />
                  </div>
                  <div className="inputBox">
                    <Field type="text" name="twitter_link" />
                  </div>
                  <div className="inputBox">
                    <Field type="text" name="tiktok_link" />
                  </div>
                  <div className="inputBox">
                    <Field type="text" name="snapchat_link" />
                  </div>
                  <div className="px-10">
                    {" "}
                    <button
